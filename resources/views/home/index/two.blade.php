...
<div class="t-top"><!--头部-->
	...
	<div onMouseOut="$('#t-nav').hide();" onMouseOver="$('#t-nav').show();" style="background:#D2B48C">
		<span>我要贷款</span>
	</div>

</div><!--头部-->
<div class="t-main1" >
	<span style="padding-top: 20px;color:#FAEBD7">家庭信息</span>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 家庭住址：</label><input type="text" class="name-input home_address" />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 现居地址：</label><input type="text" class="name-input now_address " />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 微信号：</label><input type="text" class="name-input weixin" />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 父亲电话：</label><input type="text" class="name-input father_mobile " />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 母亲电话：</label><input type="text" class="name-input  mother_mobile" />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" class="selcet-input">
		<label><font class="xin">*</font> 异性电话：</label><input type="text" class="name-input girlfriend_mobile " />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;" >
		<label><font class="xin">*</font> 外卖地址：</label><input type="text" class="name-input waimai " />
	</div>
	<div class="t-main2-list" style="padding-top: 20px;">
		<label><font class="xin">*</font> 淘宝地址：</label><input type="text" class="name-input taobao " />
	</div>
</div>
<a ><div class="subbtn subbtntwo" style="background:#D2B48C">下一步</div></a>
