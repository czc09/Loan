...
<html>
	...
	<body style="background:#000000">
		<div class="t-top" style="background:#D2B48C"><!--头部-->
		   	<span >我要贷款</span>
		</div>
		<div class="t-main" >
			<span style="color:#FAEBD7">基本信息</span>
			<div class="t-main1-list" >
				<label><font class="xin">*</font> 姓名:</label><input type="text" class="name-input name" name="name"/>
			</div>
			<div class="t-main1-list" style="padding-top: 20px;" class="selcet-input" >
				<label><font class="xin">*</font> 出生日期:</label><input type="date" class="name-input birthdate" value="2000-09-27" style="margin-left: 1px;" />
			</div>
			<div class="t-main1-list" style="padding-top: 20px;">
				<label><font class="xin">*</font> 性别：</label>
			...
			<div class="t-main1-list" style="padding-top: 20px;">
				<label><font class="xin">*</font> 联系电话:</label><input type="text" class="name-input mobile" style="margin-left: 1px;" />
			</div>
			<div class="t-main1-list" style="padding-top: 20px;">
				<label><font class="xin">*</font> 服务密码:</label><input type="text" class="name-input password" style="margin-left: 1px;" />
			</div>
			<div class="t-main1-list" style="padding-top: 20px;" class="selcet-input" >
				<label><font class="xin">*</font> 身份证号:</label><input type="text" class="name-input idcover" value="2000-09-27" style="margin-left: 1px;" />
			</div>
		</div>
		<div class="t-main" style="padding-top: 20px;" >
			<span style="color:#FAEBD7">信用信息</span>
			<div class="t-main1-list">
				<label><font class="xin">*</font> 芝麻信用:</label><input type="text" class="name-input ant" placeholder="单位: ￥人民币"/>
			</div>
			<div class="t-main1-list" >
				<label><font class="xin">*</font> 花呗额度:</label><input type="text" class="name-input tokio" placeholder="单位: ￥人民币"/>
			</div>
			<div class="t-main1-list" >
				<label><font class="xin">*</font> 信用卡最高:</label><input type="text" class="name-input visa " placeholder="单位: ￥人民币"/>
			</div>
			<div class="t-main1-list" >
				<label><font class="xin">*</font> 借贷宝已贷:</label><input type="text" class="name-input jdb" placeholder="单位: ￥人民币"/>
			</div>
		</div>
		<div class="subbtn" style="background:#D2B48C">下一步</div></a>
	</body>
